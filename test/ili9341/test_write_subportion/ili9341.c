...
void f10xxx_reset_isr(){
  ...
  i = 100000;
  while(i--); // wait at least 5ms

  usart_write_str(usart_1, (u8 *) "Sleep OUT\n");
  ...
  usart_write_str(usart_1, (u8 *) "DISPLAY ON\n");
  ...
  f10xxx_spi_write(spi_1, 0);
  while(!f10xxx_spi_status(spi_1, spi_rx_not_empty));
  f10xxx_spi_read(spi_1);

  f10xxx_spi_write(spi_1, 110); // SC 110
  while(!f10xxx_spi_status(spi_1, spi_rx_not_empty));
  f10xxx_spi_read(spi_1);
  ...
  f10xxx_spi_write(spi_1, 130); // EC 130
  while(!f10xxx_spi_status(spi_1, spi_rx_not_empty));
  f10xxx_spi_read(spi_1);
  ...
  usart_write_str(usart_1, (u8 *) "Start write frame\n");
